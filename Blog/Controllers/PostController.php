...
class PostController extends Controller {
	...
	public function save_category(Request $request){
		  ...
		  $messages = array('required' => 'The category name is required.');
            ...
            $v = Validator::make($request->all(),['category_name'=>'required | unique:blog_category'],$messages);
	...
	public function update_category(Request $request){
            ...
            $v = Validator::make($request->all(),['category_name'=>'required |  unique:blog_category,category_name,'.$id ],$messages);
	...
	public function categorywise($category)
	{
			...
			$posts = Posts::where('active','1')->where('category','like','%'.$category.'%')->orderBy('created_at','desc')->paginate(5);
	...
	public function edit(Request $request,$slug)
	{
			...
			$post = Posts::where('slug',$slug)->first();
				...
				return view('Blog::posts.edit')->with('post',$post)->with('data',$data)->with('category',$category);
			}else
			{
