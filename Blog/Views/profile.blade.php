	...
	<div class="list-group">
		...
		@foreach($latest_comments as $latest_comment)
			<div class="list-group-item">
				...
				<p>On post <a href="{{ url('/'.$latest_comment->post->slug) }}">{{ $latest_comment->post->title }}</a> By {{ $latest_comment->post->author->name }}</p>
			</div>
		@endforeach
		@else
		<div class="list-group-item">
			<p>You have not commented on any post till now. Your latest 5 comments will be displayed here</p>
		</div>
		@endif
	</div>
</div>
